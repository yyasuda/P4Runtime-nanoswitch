...
FLOOD_GRP = b'\x00\x01'
# Flooding port number is -1 (python program internal use)
...
def packetin_process(pin):
    ...
    # when destination is broadcast, do flooding
...
def Test():
    # insertFlowEntry( dst, src, port ) 
    insertFlowEntry(b'\xff\xff\xff\xff\xff\xff' , b'\x00\x00\x00\x00\x00\x01' , FLOOD_PORT)
    return
    insertFlowEntry(b'\x00\x00\x00\x00\x00\x02' , b'\x00\x00\x00\x00\x00\x01' , b'\x00\x02')
    return
